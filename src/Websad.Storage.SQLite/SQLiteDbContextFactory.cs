...
namespace Websad.Storage.SQLite
{
    public class SQLiteDbContextFactory : IDesignTimeDbContextFactory<SQLiteDbContext>
    {
        ...
        public SQLiteDbContext CreateDbContext(string[] args) {
            ...
            services.Configure<WebsadConfig>(options => configuration.Bind(options));

            var siteSettings = services.BuildServiceProvider().GetRequiredService<IOptionsSnapshot<WebsadConfig>>();
